  ...
  <div class="container">
    ...
    <div class="sidebar" v-show="showSide">
      <div class="head">
        <!-- img user -->
        <div class="user-img">
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" fill="currentColor" class="bi bi-person-circle"
            viewBox="0 0 16 16">
        ...
        <div class="user-details">
          <p class="title">Admin or Customer or Unknown</p>
          <p class="name">Name</p>
        </div>
      </div>
      <div class="nav">
        <div class="menu">
          ...
          <ul>
            ...
            <router-link to="/homepage" class="rout">
              <li class="active">
                <a href="#"><i class="bi bi-cup-straw"></i>
                  <span class="text">Food</span>
                </a>
              </li>
            </router-link>
        ...
        <div class="search-top">
          ...
          <div class="cart">
            ...
            <ul>
              <router-link to="/" class="rout">
              <li>
                        <a href="#"><i class="cart-img bi bi-cart2"></i><span>Cart (0)</span></a>
              </li>
            </router-link>
            </ul>
